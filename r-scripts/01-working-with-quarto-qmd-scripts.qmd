...
### Benefits of using Quarto over regular R scripts
...
### Rendering a Quarto file to different types of formatted output
...
|-----------|------------------------------------------------|
| docx      | Word file                                      |
| gfm       | Markdown file automatically rendered in Github |
| PDF       | Acrobat PDF                                    |
...
### Using different execution options in a code chunk
